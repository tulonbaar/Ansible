...
$sourcePath = "L:\RMAN_HARTERP"
$currentDate = Get-Date -Format "yyyyMMdd"
$destinationPath = "X:\Oracle\$currentDate\RMAN_HARTERP"
...
$newestFiles = Get-ChildItem -Path $sourcePath
...
Write-Host "Files have been copied successfully."