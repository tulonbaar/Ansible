# Remove: 
# Older than: 3 months
# If less than 6 folders don't remove
...
if ($directories.Count -gt 0) {
    # Check if the total count of directories is less than 6
    if ($directories.Count -lt 6) {
        Write-Output "Total directory count is less than 6. No directories will be removed."
        return
    }
