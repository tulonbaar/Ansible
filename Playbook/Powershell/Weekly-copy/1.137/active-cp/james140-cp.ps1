...
$sourcePath = "Z:\James140" # Update this with your actual source folder path
$destinationPath = "X:\James140\$currentDate\" # Update this with your actual destination folder path
