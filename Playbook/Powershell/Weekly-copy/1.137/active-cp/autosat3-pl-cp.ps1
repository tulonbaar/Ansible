...
$sourcePath = "Z:\Autosat3_PL" # Update this with your actual source folder path
$destinationPath = "X:\Autosat3_PL\$currentDate\" # Update this with your actual destination folder path
...
# Define a date limit (1 week ago from the current date)
