...
$sourcePath = "Z:\Rachunek50" # Update this with your actual source folder path
$destinationPath = "X:\Rachunek50\$currentDate\" # Update this with your actual destination folder path
