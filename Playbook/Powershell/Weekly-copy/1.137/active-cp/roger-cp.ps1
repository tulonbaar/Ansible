...
$sourcePath = "Z:\Roger" # Update this with your actual source folder path
$destinationPath = "X:\Roger\$currentDate\" # Update this with your actual destination folder path
