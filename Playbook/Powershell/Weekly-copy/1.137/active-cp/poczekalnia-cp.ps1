...
$sourcePath = "Z:\Poczekalnia" # Update this with your actual source folder path
$destinationPath = "X:\Poczekalnia\$currentDate\" # Update this with your actual destination folder path
