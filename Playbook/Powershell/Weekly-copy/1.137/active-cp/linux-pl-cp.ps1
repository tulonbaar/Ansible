...
$sourcePath = "Z:\LinuxPL" # Update this with your actual source folder path
$destinationPath = "X:\LinuxPL\$currentDate\" # Update this with your actual destination folder path
