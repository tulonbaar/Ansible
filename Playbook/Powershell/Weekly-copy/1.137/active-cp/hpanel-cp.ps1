...
$sourcePath = "Z:\Hpanel" # Update this with your actual source folder path
$destinationPath = "X:\Hpanel\$currentDate\" # Update this with your actual destination folder path
