...
$sourcePath = "Z:\James139" # Update this with your actual source folder path
$destinationPath = "X:\James139\$currentDate\" # Update this with your actual destination folder path
