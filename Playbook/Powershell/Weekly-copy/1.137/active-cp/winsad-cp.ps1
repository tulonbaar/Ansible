...
$sourcePath = "Z:\WinSad" # Update this with your actual source folder path
$destinationPath = "X:\WinSad\$currentDate\" # Update this with your actual destination folder path
