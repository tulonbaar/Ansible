# Copy files not older than 1 days (Too many files either way)

# Current date
$currentDate = Get-Date -Format "yyyyMMdd"

$sourcePath = "Z:\AX2012" # Update this with your actual source folder path
$destinationPath = "X:\AX2012\$currentDate\" # Update this with your actual destination folder path
