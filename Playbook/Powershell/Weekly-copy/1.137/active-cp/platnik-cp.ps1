...
$sourcePath = "Z:\Platnik" # Update this with your actual source folder path
$destinationPath = "X:\Platnik\$currentDate\" # Update this with your actual destination folder path
