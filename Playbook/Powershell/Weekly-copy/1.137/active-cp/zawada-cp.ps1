...
$sourcePath = "Z:\Zawada" # Update this with your actual source folder path
$destinationPath = "X:\Zawada\$currentDate\" # Update this with your actual destination folder path
