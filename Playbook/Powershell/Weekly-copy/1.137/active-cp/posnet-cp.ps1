...
$sourcePath = "Z:\Posnet" # Update this with your actual source folder path
$destinationPath = "X:\Posnet\$currentDate\" # Update this with your actual destination folder path
